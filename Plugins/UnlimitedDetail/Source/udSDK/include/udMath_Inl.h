//! @file udMath_Inl.h
//! Inline implementations for the math types and functions declared in udMath.h.
//! This file is included automatically at the end of udMath.h and should not be included directly.
...
inline T udNormaliseRotation(T rad, T absRange)
{
  ...
  {
    T c = T(int64_t(udRound(rad / absRange)));
